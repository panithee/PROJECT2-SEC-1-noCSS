...
<template>
  <div class="w-full h-full">
    ...
    <div class="flex justify-between w-64 pb-2 mx-auto mt-2 overflow-x-scroll">
      <button v-for="(person, index) in personsList" :id="index" :key="index"
              :class="
    ...
    <button
        class="flex justify-center px-2 mx-auto mt-5 text-2xl hover:bg-white shadow-md hover:text-black hover:rounded-lg"
